...
- It prevents unnecessary blocking when threads have other useful tasks to perform
- This is particularly useful in scenarios where threads have multiple independent tasks to perform
